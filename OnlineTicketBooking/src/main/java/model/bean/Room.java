...
public class Room {
	...
	/*
	 * Generate seat with number of rows and number of columns
	 * startId is start id of seat
	 * number of rows must be in 1 and 26 because alphabet just have 26 letter
	 * seat name is a combination of letter and number
	 */
	private Seat[] generateSeat(int numberOfRows, int numberOfColumns, int startId){
		if(numberOfRows < 1 && numberOfRows > 26) throw new IllegalArgumentException("Number of row must be in 1 and 26 ");
