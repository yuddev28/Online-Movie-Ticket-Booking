...
<body>
	<div class="container-fluid">
		<form action="${pageContext.request.contextPath }/admin/movies">
			<input type="submit" value="Quay lại" class="btn btn-primary">
		</form>
		<c:if test="${not empty sessionScope.errorMessage }">
			<div id="message"
		         class="bg-warning text text-white px-3 py-2 rounded d-inline-flex align-items-center gap-2 mt-2">
